...
public class NestedPullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	public NestedPullToRefreshListView(Context context) {
		super(context);
		setDisableScrollingWhileRefreshing(false);
	}

	public NestedPullToRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		setDisableScrollingWhileRefreshing(false);
	}

	public NestedPullToRefreshListView(Context context, Mode mode) {
		super(context, mode);
		setDisableScrollingWhileRefreshing(false);
	}
	...
	class InternalListView extends ListView implements EmptyViewMethodAccessor, NestedScrollingChild {
		...
		public void setEmptyView(View emptyView) {
			NestedPullToRefreshListView.this.setEmptyView(emptyView);
		}
