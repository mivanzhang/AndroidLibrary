...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private LoadingView mHeaderLayout;
	private LoadingView mFooterLayout;
	 ...
	 * <code>setPullLabel(pullLabel, Mode.BOTH)</code>
	 * 
	 * @param pullLabel
	 *            - String to display
	 */
	 ...
	 * <code>setRefreshingLabel(refreshingLabel, Mode.BOTH)</code>
	 * 
	...
	protected final LoadingView getFooterLayout() {
	...
	protected final LoadingView getHeaderLayout() {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            Parcelable temState = bundle.getParcelable(STATE_SUPER);
            if (temState == null || temState instanceof AbsSavedState) {
                super.onRestoreInstanceState(temState);
            } else {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mHeaderLayout = createLoadingView(context, Mode.PULL_DOWN_TO_REFRESH, a);
		mFooterLayout = createLoadingView(context, Mode.PULL_UP_TO_REFRESH, a);
