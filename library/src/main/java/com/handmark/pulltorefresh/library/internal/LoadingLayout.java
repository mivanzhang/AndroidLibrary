...
public class LoadingLayout extends LoadingView {
	...
	public LoadingLayout(Context context, final Mode mode, TypedArray attrs) {
        ...
        //TODO
        frameImage = (ImageView) header.findViewById(R.id.pull_to_refresh_frame_image);
        frameImage.setBackgroundResource(R.drawable.refreshing_animtaion);
		...
		if (null == imageDrawable) {
			imageDrawable = context.getResources().getDrawable(R.drawable.refresh_image);
		}
	...
	public void reset() {
        ...
        AnimationDrawable animationDrawable = (AnimationDrawable)frameImage.getBackground();
	...
	public void refreshing() {
        ...
        if (mHeaderImage.getVisibility() == View.VISIBLE) {
    ...
    public void setFrameImageBackground(Drawable drawable) {
        frameImage.setBackgroundDrawable(drawable);
    }

    public void setFrameImageVisibility(int visibility) {
        frameImage.setVisibility(visibility);
    }

    public void setHeaderTextVisibility(int visibility) {
        mHeaderText.setVisibility(visibility);
    }
